...
const ROUTES = {
  "/": {
    ...
    description:
      "IDR Tech is a premier web development company in Bharuch, Gujarat. We build high-performance business websites, custom UI/UX designs, e-commerce platforms, hosting solutions, and site maintenance to help your brand rank and convert.",
    keywords:
      "IDR Tech, web development company in Bharuch, Bharuch web developer, website design Bharuch, Gujarat web development, UI UX design Bharuch, business website India, e-commerce development, digital agency Bharuch, responsive website, website maintenance",
    robots:
  ...
  "/about": {
    ...
    description:
      "Meet the IDR Tech team — a passionate agency based in Bharuch, Gujarat, delivering scalable digital web experiences, modern interfaces, and professional full-stack designs for growing businesses.",
    keywords:
      "About IDR Tech, Indrajit Padhiyar, Drumul Thakor, Rohit Patil, web developers Bharuch, design studio Bharuch, agency team, software developers Gujarat",
    robots: "index, follow",
  },
  "/projects": {
    title: "IDR TECH | Portfolio",
    description:
      "Explore the IDR Tech client portfolio: custom responsive business websites, React apps, refined motion interfaces, and professional full-stack developments.",
    keywords:
      "web design portfolio, React showcase, web agency projects, client work IDR Tech, software engineering portfolio, web development Bharuch",
    robots: "index, follow",
  },
  "/our-work": {
  ...
  "/services": {
    ...
    description:
      "Discover IDR Tech services: bespoke web development, custom UI/UX design systems, e-commerce stores, modern SEO optimizations, and reliable website hosting & maintenance in Bharuch.",
    keywords:
      "web development services, custom website designer, React development company, UI UX consulting, SEO optimization agency, website maintenance Bharuch",
    robots: "index, follow",
  },
  "/tech-showcase": {
    title: "Interactive Tech Lab | Full Stack & 3D WebGL Showcase | IDR Tech",
    description:
      "Step into the IDR Tech interactive full-stack laboratory: dynamic React showcases, 3D WebGL renderers, custom motion components (GSAP, Framer Motion), and comprehensive backend integrations (Node.js, Express, databases).",
    keywords:
      "interactive lab, 3D WebGL React, full stack showcase, GSAP animation lab, Three.js developer, developer showcase",
    robots: "index, follow",
  },
  "/contact": {
    title: "Contact IDR Tech | Hire Web Developers in Bharuch",
    description:
      "Get in touch with IDR Tech to launch your next web project. Request a custom design and development quote or secure priority support.",
    keywords:
      "contact IDR Tech, hire web developer, website quote, design agency contact, support idr tech",
    robots: "index, follow",
  },
  "/terms": {
    title: "Terms of Service | IDR Tech",
    description:
      "Official terms of service and usage regulations for using IDR Tech websites, products, and custom digital services.",
  ...
  "/privacy": {
    ...
    description:
      "Understand how IDR Tech collects, uses, updates, and protects client information and website user data.",
  ...
  "/refund": {
    ...
    description:
      "Our customer satisfaction commitment and standard refund policy for IDR Tech web development and related digital services.",
  ...
  "/cancellation": {
    ...
    description:
      "Cancellation parameters, notice requirements, and standard terms for terminating IDR Tech contracts and digital subscriptions.",
  ...
  "/disclaimer": {
    ...
    description:
      "Legal disclaimers regarding the website information, resources, and advice provided by IDR Tech.",
    keywords: "disclaimer, liability disclaimer, legal notices",
    robots: "noindex, follow",
  },
  "/website-maintenance": {
    title: "Professional Website Maintenance & AMC Plans | IDR Tech",
    description:
      "Ensure 24/7 uptime, security, backups, speed, and optimization with IDR Tech's professional Website Maintenance (AMC) plans. Support for business and enterprise websites.",
    keywords:
      "website maintenance plans, annual maintenance contract website, AMC website support, security updates website, weekly backups, website monitoring, bug fixes, site performance optimization",
    robots: "index, follow",
  },
...
const generateAboutSchema = () => ({
  ...
  name: "About IDR Tech",
  description:
    "Meet the IDR Tech team, an agency located in Bharuch, Gujarat offering custom full-stack solutions, high performance, and visual excellence.",
  mainEntity: {
    "@type": "Organization",
    name: "IDR Tech",
    knowsAbout: [
...
const generateServicesSchema = () => ({
  ...
  serviceOutput:
    "Responsive web applications, custom user interface design systems, fast e-commerce setups, and SEO optimization.",
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "High-performance React/Node.js web application designs optimized for Core Web Vitals.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Modern, user-centric wireframing, premium color styles, custom layouts, and interactive design systems.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Tailored shopping carts, secure checkout architectures, payment gateway integrations, and admin backends.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Implementation of modern semantic markup, structured JSON-LD schemas, and tags for Google and AI bot discovery.",
        },
      },
    ],
  },
...
const generateContactSchema = () => ({
  ...
  description:
    "Reach out to IDR Tech for custom web development estimates, design audits, and consulting support in Bharuch.",
  mainEntity: {
...
const generateProjectsSchema = () => ({
  ...
  description:
    "Explore interactive React projects, custom web services, and user interfaces engineered by IDR Tech.",
});

const generateMaintenanceSchema = () => ({
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": `${SITE_URL}/website-maintenance/#service`,
  name: "Website Maintenance & Support (AMC)",
  provider: {
    "@id": `${SITE_URL}/#organization`,
  },
  serviceOutput:
    "24/7 Uptime, Security Patches, Weekly Backups, Performance Optimization, and Technical Support.",
  description:
    "Ensure 24/7 security, weekly backups, speed, and optimization with IDR Tech's professional Website Maintenance (AMC) plans.",
  hasOfferCatalog: {
    "@type": "OfferCatalog",
...
export function applyRouteSeo(pathname) {
  ...
  const organizationSchema = {
    ...
    description:
      "IDR Tech is an enterprise-level web development and UI/UX design studio based in Bharuch, Gujarat.",
    sameAs: [
  ...
  if (path === "/" || path === "/home") {
    pageSchema = {
      ...
      image: `${SITE_URL}/IDR.jpeg`,
      description:
        "IDR Tech is a high-performance web development and design agency based in Bharuch, Gujarat.",
      priceRange: "$$",
      telephone: "+919714833771",
      email: "idrtech23@gmail.com",
      address: {
    ...
    pageSchema = generateMaintenanceSchema();
  } else {
    pageSchema = {
      "@context": "https://schema.org",
      "@type": "WebPage",
