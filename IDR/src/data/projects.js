export const projects = [
  ...
  },
  {
    ...
    link: "#contact",
    description:
      "A premium portfolio layout with clean spacing and strong visual flow.",
    color: "bg-[#E6EE9C]",
    height: "aspect-[3/5]",
  },
  {
    title: "lamp Landing page",
    category: "Design",
    image: "/images/lamp.png",
    link: "https://wall-lemps.onrender.com",
    description:
      "a premium wall-lamp layout with clean spacing and strong visual flow.",
    color: "bg-[#E6EE9C]",
    height: "aspect-[3/5]",
  },
  {
    ...
    description:
      "a premium hotel landing page with clean spacing and strong visual flow.",
    color: "bg-[#E6EE9C]",
    height: "aspect-[3/5]",
  },
  {
