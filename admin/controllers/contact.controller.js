    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" 
          style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 5px 25px rgba(0,0,0,0.08);">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:15px;">
                ...
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #eee;">
                    <b style="color:#6b7280;">Name:</b><br/>
                    ${name}
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #eee;">
                    <b style="color:#6b7280;">Email:</b><br/>
                ...
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #eee;">
                    <b style="color:#6b7280;">Subject:</b><br/>
                    ${subject}
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:15px 0;">
                    <b style="color:#6b7280;">Message:</b>
                    <div style="margin-top:8px;padding:15px;background:#f9fafb;border-radius:8px;">
                      ${message}
                    </div>
                  </td>
                </tr>
          ...
          <tr>
            <td style="background:#f9fafb;padding:20px;text-align:center;font-size:13px;color:#6b7280;">
              ...
              <p style="margin:5px 0 0;">© ${new Date().getFullYear()} Your Brand</p>
            </td>
          </tr>
